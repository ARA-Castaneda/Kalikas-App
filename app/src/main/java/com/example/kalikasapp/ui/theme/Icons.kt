...
// Main screen signup
public val App_registration: ImageVector
    get() {
        if (_App_registration != null) {
...
// Merchant signup
public val Card_travel: ImageVector
    get() {
        if (_Card_travel != null) {
            return _Card_travel!!
        }
    ...
    get() {
        ...
        _Footprint = ImageVector.Builder(
            ...
            path(
                ...
                reflectiveQuadToRelative(-72.5f, 50f)
...
// Add student or educator user location
public val Share_location: ImageVector
    get() {
...
// Add student or educator user institution
public val Account_balance: ImageVector
    get() {
...
// Add merchant user business type
public val Cases: ImageVector
    get() {
        if (_Cases != null) {
            return _Cases!!
        }
