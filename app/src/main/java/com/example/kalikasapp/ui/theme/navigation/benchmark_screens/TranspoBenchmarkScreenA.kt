...
@Composable
fun TranspoBenchmarkScreenA(navController: NavController) {
    BenchmarkTranspoScreen(
        navController, { TranspoQuestionsSetA() }, Screen.TranspoBenchmarkScreenB.route,
    )
}

@Composable
fun TranspoQuestionsSetA() {
    Card(
        modifier = Modifier
        ...
        Column(
            ...
            Image(
                painter = painterResource(R.drawable.transpobench_a),
...
@Composable
fun TranspoBenchmarkScreenAPreview() {
