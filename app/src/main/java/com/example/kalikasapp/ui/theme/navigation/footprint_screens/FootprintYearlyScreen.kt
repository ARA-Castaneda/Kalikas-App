...
val userYearlies = listOf(
    ...
    FootprintModel(userYearlyFood, foodPrint),
    FootprintModel(userYearlyWaste, wastePrint)
)

@Composable
fun FootprintYearlyScreen(navController: NavController) {
    Scaffold(
        bottomBar = {
                ...
                Box(
                    ...
                    Row(
                        ...
                        Column(
                            ...
                            YearlyWaterLogsButton(navController)
                            YearlyEnergyLogsButton(navController)
                            YearlyTranspoLogsButton(navController)
                            YearlyFoodLogsButton(navController)
                        }
                        ...
                        Column(
                            ...
                            YearlyWasteLogsButton(navController)
                            Box(
                                modifier = Modifier
                                ...
                                FootprintPieChart(userYearlies)
                            }
                        }
                    }
...
fun YearlyCarbonFootprint() {
    Column(
        ...
        Column(
            ...
            Text(
                text = String.format(Locale.US, "%.2f", userYearlyCarbonFootprint)
                    .toFloat().toString(),
                textAlign = TextAlign.Center,
                color = Color.DarkGray,
                fontSize = 40.sp,
...
@Composable
fun YearlyWaterLogsButton(navController: NavController){
    val yearlyWater = (userCarbonFootprint.water * 12f).toInt()
...
@Composable
fun YearlyEnergyLogsButton(navController: NavController){
    val yearlyEnergy = (userCarbonFootprint.energy * 12f).toInt()
...
@Composable
fun YearlyTranspoLogsButton(navController: NavController){
    val yearlyTranspo = (userCarbonFootprint.transpo * 12f).toInt()
...
@Composable
fun YearlyFoodLogsButton(navController: NavController){
    val yearlyFood = (userCarbonFootprint.food * 12f).toInt()
...
@Composable
fun YearlyWasteLogsButton(navController: NavController){
    val yearlyWaste = (userCarbonFootprint.waste * 12f).toInt()
...
@Composable
fun FootprintYearlyScreenPreview() {
